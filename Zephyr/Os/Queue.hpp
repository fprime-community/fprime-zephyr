// ======================================================================
// \title Os/Zephyr/Queue.hpp
// \brief Zephyr definitions for Os::Queue
// ======================================================================
#ifndef OS_ZEPHYR_QUEUE_HPP
#define OS_ZEPHYR_QUEUE_HPP
...
struct ZephyrQueueHandle : public QueueHandle {
  struct k_msgq* m_msgq = nullptr;
};

//! \brief Zephyr queue implementation with injectable statuses
class ZephyrQueue : public QueueInterface {
  public:
    ...
    ZephyrQueue(const QueueInterface& other) = delete;

    //! \brief copy constructor is forbidden
    ZephyrQueue(const QueueInterface* other) = delete;

    //! \brief assignment operator is forbidden
    ZephyrQueue& operator=(const QueueInterface& other) override = delete;
    ...
    ZephyrQueueHandle m_handle;
};

}  // namespace Zephyr
}  // namespace Os

#endif  // OS_ZEPHYR_QUEUE_HPP
