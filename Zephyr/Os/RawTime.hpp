...
struct ZephyrRawTimeHandle : public RawTimeHandle {
    U32 m_secs = 0;    //!< Seconds since boot
    U32 m_micros = 0;  //!< Milliseconds since boot
};

//! \brief Zephyr implementation of Os::RawTime
//!
//! Zephyr implementation of `RawTimeInterface`.
//!
class ZephyrRawTime : public RawTimeInterface {
  public:
    ...
    //! \brief destructor
    //!
    ~ZephyrRawTime() override = default;
  ...
  private:
    ...
    ZephyrRawTimeHandle m_handle;
};

}  // namespace Zephyr
}  // namespace Os
#endif  // OS_ZEPHYR_RAWTIME_HPP
