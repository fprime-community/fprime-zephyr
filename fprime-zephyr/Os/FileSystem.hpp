// ======================================================================
// \title fprime-zephyr/Os/FileSystem.hpp
// \brief Zephyr FileSystem definitions for Os::FileSystem
// ======================================================================
#ifndef ZEPHYR_OS_FILESYSTEM_HPP
#define ZEPHYR_OS_FILESYSTEM_HPP
...
struct ZephyrFileSystemHandle : public FileSystemHandle {};

//! \brief Zephyr implementation of Os::FileSystem
//!
//! Zephyr implementation of `FileSystemInterface` for use as a delegate class handling error-only fileSystem operations.
//!
class ZephyrFileSystem : public FileSystemInterface {
  ...
  private:
    //! FileSystem handle for ZephyrFileSystem
    ZephyrFileSystemHandle m_handle;
};  // class ZephyrFileSystem
